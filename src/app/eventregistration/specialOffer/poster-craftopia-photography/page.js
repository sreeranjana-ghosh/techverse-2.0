...
const Page = () => {
	...
	const [formData, setFormData] = useState({
		...
		teamName: "",
		imageUrl: "",
		eventName: "POSTER EXHIBITION + CRAFTOPIA + FREEZE THE FRAME",
		participants: [],
	});
			...
			<div className="flex items-center justify-center font-roboto">
				<div className="form-container p-8 rounded-lg shadow-md w-auto">
					<h1 className="text-2xl md:text-2xl font-semibold text-center mb-4 text-white">
						POSTER EXHIBITION + <hr /> CRAFTOPIA + <hr /> FREEZE THE
						FRAME
					</h1>
					<form onSubmit={handleForm}>
						<div className="form-container p-4 rounded-lg mb-4 mt-4">
							...
							<h1 className="text-red-600">
								*Only the leader can participate in both events.
							</h1>
						</div>
						<div className="mb-4">
							<label className="form-label block">
						...
						<h1 className="text-red-600">
							* POSTER EXHIBITION + CRAFTOPIA + FREEZE THE FRAME =
							150/-
						</h1>
